...
const Header = () => {
  return (
    <header class="bg-white text-white py-4 px-6 flex justify-between items-center mx-auto max-w-screen-sm md:max-w-screen-xl">
      <div class="flex items-center">
        <img
          class="h-[35px] w-[152px] lg:h-[52px] lg:w-[189px]"
          src="logo.png"
          alt="Logo"
        />
      </div>
