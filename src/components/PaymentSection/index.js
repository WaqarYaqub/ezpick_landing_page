  ...
  return (
    <>
      <div class="bg-[#F5F5F5] py-[80px]">
        <div className="px-[30px] lg:px-[0px] bg-[#F5F5F5] grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-[30px] mx-auto max-w-screen-sm md:max-w-screen-xl">
          <div className="grid grid-rows-2 gap-[20px]">
            <div className="relative rounded-[15px] shadow-custom bg-white py-[30px] px-[30px]">
              <span className="cursor-pointer absolute top-[25px] right-[25px]">
